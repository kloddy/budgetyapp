...
let UIController = (function(){
    ...
    return {
        ...
        clearfields: function(){
            ...
            // THIS CAN ACCEPT 3 ARGUMENTS INTO THE PARAMETER
            // CURRENT IS inputDescription and index is 
        ...
        displayPercentages: function(percentages){
            ...
            let fields = document.querySelectorAll(DOMstrings.expensesPercLabel); // returns a nodelist.
        ...
        displayDate: function() {
            let now, year, month, monthss;
            now = new Date();
            // let christmas = new Date(2018, December, 25);
